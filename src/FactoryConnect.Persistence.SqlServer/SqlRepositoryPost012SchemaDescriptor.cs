...
internal static class SqlRepositoryPost012SchemaDescriptor
{
    ...
    public static SqlSchemaDescriptor Create(SqlSchemaDescriptor post011)
    {
        ...
        [
            ...
            Table(
                ...
                checks:
                [Check("CK_ProductionReferenceTimeRevision_UInt64Positive", "([ProductionReferenceTimeRevision]>=(1) AND [ProductionReferenceTimeRevision]<=(18446744073709551615.))")]),
            Table(
                ...
                [
                    ...
                    Text("ShiftId"),
                    Text("ProductionContextAssignmentId", isNullable: true),
                    Text("ProductionOrderId", isNullable: true),
                    Text("OperationId", isNullable: true),
                    Text("PartId", isNullable: true),
                    Text("OperatorId", isNullable: true),
                    ...
                    DateTimeOffset("SelectedStandardEffectiveFromUtc", 7, isNullable: true),
                ...
                checks:
                [
                    Check("CK_ProductionReferenceTimeOutcome_Revision_UInt64Positive", "([ProductionReferenceTimeRevision]>=(1) AND [ProductionReferenceTimeRevision]<=(18446744073709551615.))"),
                    ...
                    Check("CK_ProductionReferenceTimeOutcome_Utc", "(datepart(tzoffset,[OccurredAtUtc])=(0) AND ([SelectedStandardEffectiveFromUtc] IS NULL OR datepart(tzoffset,[SelectedStandardEffectiveFromUtc])=(0)))"),
            ...
            Table(
                ...
                PrimaryKey("PK_ProductionReferenceTimePublicationCut", "MetricAggregationProcessorRowId", "MetricAggregationPosition"),
                foreignKeys:
                [
                ...
                [
                    ...
                    Check("CK_ProductionReferenceTimePublicationCut_ReferenceRevision_UInt64Positive", "([ProductionReferenceTimeRevision]>=(1) AND [ProductionReferenceTimeRevision]<=(18446744073709551615.))")
                ])
        ]);
    }
    ...
    private static SqlColumnDescriptor Text(string name, bool isNullable = false) => Column(name, "nvarchar", 256, isNullable, BinaryCollation);
