...
internal static class SqlRepositorySchemaAuthority
{
    ...
    [
        ...
        Table("MachineActivityPeriodHistory"),
        Table("MachineObservation"),
        Table("MachineShiftOccurrenceRoster"),
        Table("MachineShiftOccurrenceRosterOccurrence"),
        Table("MachineStateActivityAuthority"),
        Table("MachineStateActivitySignal"),
        Table("MachineStateChangeHistory"),
        Table("MappingCoverageAuthority"),
        Table("MetricAggregationCheckpoint"),
        Table("MetricAggregationContribution"),
        Table("MetricAggregationProcessor"),
        Table("MetricAggregationRevision"),
        Table("MetricAggregationRevisionProductionDay"),
        Table("MetricAggregationRevisionShiftOccurrence"),
