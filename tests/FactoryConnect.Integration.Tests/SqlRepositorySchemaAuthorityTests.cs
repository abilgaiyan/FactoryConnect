...
public sealed class SqlRepositorySchemaAuthorityTests
{
    ...
    public void OwnedObjectsExposeRepositoryMembershipWithoutCatalogCaseResolution()
    {
        ...
        Assert.True(ownedObjects.ContainsRepositoryIdentity(new SqlObjectName("dbo", "MappingCoverageAuthority")));
        Assert.True(ownedObjects.ContainsRepositoryIdentity(new SqlObjectName("dbo", "MachineStateActivityAuthority")));
        ...
        Assert.False(ownedObjects.ContainsRepositoryIdentity(new SqlObjectName("dbo", "mappingcoverageauthority")));
